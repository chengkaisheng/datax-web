...
public class TriggerCallbackThread {
    ...
    public static void pushCallBack(HandleCallbackParam callback) {
        ...
        logger.debug(">>>>>>>>>>> DataElit, push callback request, logId:{}", callback.getLogId());
    }
    ...
    public void start() {
        ...
        triggerCallbackThread.setName("DataElit, executor TriggerCallbackThread");
    ...
    private static String failCallbackFileName = failCallbackFilePath.concat("DataElit-callback-{x}").concat(".log");
