...
public class JobTriggerPoolHelper {
     ...
     * add trigger
     */
    public void addTrigger(final int jobId, final TriggerTypeEnum triggerType, final int failRetryCount, final String executorShardingParam, final String executorParam,final String jobInfoId,final String infoId,final long virtualLogId) {
        ...
        triggerPool_.execute(() -> {
            ...
            try {
                // do trigger
                JobTrigger.trigger(jobId, triggerType, failRetryCount, executorShardingParam, executorParam,jobInfoId,infoId,virtualLogId);
            } catch (Exception e) {
    ...
    public static void trigger(int jobId, TriggerTypeEnum triggerType, int failRetryCount, String executorShardingParam, String executorParam,String jobInfoId,String infoId,long virtualLogId) {
        helper.addTrigger(jobId, triggerType, failRetryCount, executorShardingParam, executorParam,jobInfoId,infoId,virtualLogId);
    }
